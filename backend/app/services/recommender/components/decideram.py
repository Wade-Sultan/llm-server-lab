...
class RAMSelection(dspy.Signature):
    """
    Select the best RAM kit for this build from the given candidates.
 
    Candidates already match the required DDR generation. Focus on capacity
    vs. speed vs. price tradeoffs. For gaming, 32GB DDR5-5600 is rarely
    meaningfully better than 32GB DDR5-6000 at $40 more — call that out.
    """
    ...
    candidates: str = dspy.InputField(
        desc="JSON list of compatible RAM kits. Fields: name, ddr_gen, capacity_gb, "
             "speed_mhz, kit_count, street_price_usd"
    )
 
    ram_name: str = dspy.OutputField(desc="Exact product name of the chosen RAM kit")
